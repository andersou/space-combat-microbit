...
naves = [Nave(balas_group.add),Nave(balas_group.add),Nave(balas_group.add),Nave(balas_group.add),Nave(balas_group.add),Nave(balas_group.add),Nave(balas_group.add),Nave(balas_group.add)]
